...
return [
    ...
    'auth' => [
        ...
        'extra_info' => 'You can obtain your API token by registering a new user with the `/api/auth/register` endpoint or logging in with the `/api/auth/login` endpoint. The token will be included in the response.',
    ],
